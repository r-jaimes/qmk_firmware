 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      | Mouse|Lower |Lower |Space |Raise |Delete|      |      |      |
 * `-----------------------------------------------------------------------------------'
 */
[_COLEMAK] =  LAYOUT_split_3x6_3(
    ...
    CW_TOGG,                MT(MOD_LSFT, KC_Z), KC_X,               KC_C,               KC_D,               KC_V,           KC_K,           KC_H,                KC_COMMA,                KC_DOT,             MT(MOD_RSFT, KC_SLASH), KC_BSLS,
                                                                    TG(_MOUSE),         LT(_LOWER, KC_TAB), LT(_LOWER, KC_TAB),         KC_SPC,         LT(_RAISE, KC_BSPC), LT(_FUNCTION,KC_DELETE)
),
...
[_QWERTY] = LAYOUT_split_3x6_3(
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT ,
            TG(_MOUSE), LT(_LOWER, KC_TAB), KC_SPC, KC_SPC, LT(_RAISE, KC_BSPC), LT(_FUNCTION,KC_DELETE)
),
